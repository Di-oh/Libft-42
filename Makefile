...
#    Updated: 2023/05/17 12:15:16 by dionmart         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
NAME 	= libft.a
HEADER 	= libft.h
...
OBJS 	= ft_strlen.o ft_isalpha.o ft_isalnum.o ft_isdigit.o ft_isascii.o \
		  ...
		  ft_strchr.o ft_strrchr.o ft_strncmp.o ft_memchr.o ft_memcpy.o \
		  ft_memcmp.o ft_memmove.o ft_strlcpy.o ft_strlcat.o ft_strnstr.o \
		  ft_atoi.o ft_strdup.o ft_calloc.o
